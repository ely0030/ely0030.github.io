...
const PAGE_CSS='#rsvp button[data-pre=true]:not([aria-pressed=true]){border:1.5px dashed #00a884;background:#f0fbf7}'+
...
const page='<!doctype html><html lang="nl"><head><script src="/filmmaand/identity/reset-guard.js"></script>'+
 ...
 '<style>'+css+'</style><style>'+eggsCss+'</style><style>'+PAGE_CSS+'</style></head><body>'+markup+
