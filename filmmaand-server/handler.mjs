...
async function initialize(){
 ...
 const mail=createMail({store,apiKey:env.RESEND_API_KEY,from:env.AUTH_FROM,allowedRecipients:registration.allowedRecipients,allowAnyRecipient:registration.allowAnyRecipient,enabled:env.AUTH_MAILER==='resend'});
