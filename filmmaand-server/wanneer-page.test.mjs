...
test('the shipped page is the generated kit page, without sample people or kit state',()=>{
 ...
 assert.deepEqual([...page.matchAll(/<script src="([^"]+)"/g)].map(m=>m[1]),['/filmmaand/identity/reset-guard.js','/filmmaand/identity/avatars.js','/filmmaand/wanneer/wanneer.js','/filmmaand/wanneer/games.js',...film]);
