...
const TABLES=['participants','login_codes','sessions','rate_limits','claims','receipts'];
export const emptyState=()=>({format:1,auth:{},plans:{},images:{owners:{}},outbox:{}});
export function openState(input){
 const state=structuredClone(input);if(state.format!==1)throw Error('Unsupported Filmmaand state');
