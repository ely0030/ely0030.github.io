...
export function mountRating(imdb,id){
  ...
  const line=document.createElement('span');line.className='hp-rt-score';const logo=document.createElement('img');logo.src='/filmmaand/site/ratings/rotten-tomatoes.png';logo.alt='Rotten Tomatoes®';logo.width=62;logo.height=18;logo.addEventListener('error',()=>{logo.replaceWith(document.createTextNode('Rotten Tomatoes® '))},{once:true});line.append(logo,document.createTextNode(score.percent+'%'));
